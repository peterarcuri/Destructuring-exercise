...
console.log(`The Guardian's riddle says: ${translation}`);
...
console.log(`Essential element1: ${element1}`);
console.log(`Essential element2: ${element2}`);
...
console.log(`Extracted Stone: ${one}`);
console.log(`Extracted Stone: ${six}`);
...
console.log(`Visible Shadow: ${visible}, Hidden Shadow: ${hidden.join(", ")}`);
...
function revealPath({direction, distance}) {
	console.log(`Proceed moving ${distance} miles towards ${direction}`);
};

revealPath({direction: "East", distance: 50});
...
function mixPotion(ingredient1 = "Water", ingredient2 = "Fireflower") {
	return (`Combining ${ingredient1} with ${ingredient2}`)
};

console.log(mixPotion());
...
function castSpell([ingredient1, ingredient2]) {
	console.log(`Casting spell using ${ingredient1} and ${ingredient2}`);
};

castSpell(["Salt", "Bat wing", "Rose"]);
